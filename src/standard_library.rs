...
pub fn std() -> Vec<Knowledge> {
    vec![
        ...
        // `(\a - \b * imag) => (a + neg(b) * imag)`
        Red(app2(Sub, ret_var("a"), app2(Mul, ret_var("b"), Imag)),
            app2(Add, "a", app2(Mul, app(Neg, "b"), Imag))),
        // `add(add(\a)(mul(\b)(x)))(mul(\c)(x)) => add(a)(mul(add(\b)(\c))(x))`
        ...
        Red(app2(Mul, app2(Add, ret_var("a"), app2(Mul, ret_var("b"), "x")),
            ...
            app2(Add, app2(Add, app2(Mul, "a", "c"), app2(Mul, app2(Mul, "b", "d"), app2(Pow, "x", 2.0))),
                      app2(Mul, app2(Add, app2(Mul, "a", "d"), app2(Mul, "b", "c")), "x"))),
        // `(\a + \b * x) * (\c - \d * x) => a * c - b * d * x^2 + (a * neg(d) + b * c) * x`
        Red(app2(Mul, app2(Add, ret_var("a"), app2(Mul, ret_var("b"), "x")),
                      app2(Sub, ret_var("c"), app2(Mul, ret_var("d"), "x"))),
            app2(Add, app2(Sub, app2(Mul, "a", "c"), app2(Mul, app2(Mul, "b", "d"), app2(Pow, "x", 2.0))),
                      app2(Mul, app2(Add, app2(Mul, "a", app(Neg, "d")), app2(Mul, "b", "c")), "x"))),
        // `(\a - \b * x) * (\c + \d * x) => a * c - b * d * x^2 + (a * d - b * c) * x`
        Red(app2(Mul, app2(Sub, ret_var("a"), app2(Mul, ret_var("b"), "x")),
                      app2(Add, ret_var("c"), app2(Mul, ret_var("d"), "x"))),
            app2(Add, app2(Sub, app2(Mul, "a", "c"), app2(Mul, app2(Mul, "b", "d"), app2(Pow, "x", 2.0))),
                      app2(Mul, app2(Sub, app2(Mul, "a", "d"), app2(Mul, "b", "c")), "x"))),
        // `(\a - \b * x) * (\c - \d * x) => a * c + b * d * x^2 + (a * neg(d) - b * c) * x`
        Red(app2(Mul, app2(Sub, ret_var("a"), app2(Mul, ret_var("b"), "x")),
                      app2(Sub, ret_var("c"), app2(Mul, ret_var("d"), "x"))),
            app2(Add, app2(Add, app2(Mul, "a", "c"), app2(Mul, app2(Mul, "b", "d"), app2(Pow, "x", 2.0))),
                      app2(Mul, app2(Sub, app2(Mul, "a", app(Neg, "d")), app2(Mul, "b", "c")), "x"))),
        // `div(\x)(\y) => x / y`
